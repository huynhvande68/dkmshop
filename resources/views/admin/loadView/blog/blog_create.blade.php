...
<div class="col-12 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card_title">Viết Blog</h4>
                            <!-- enter the box product -->
                            <label  class=" pl-2 "  style=" font-size: 14px;">Nhập tên tiêu đề </label>
                            <input class="@error('name_blog') is-invalid @enderror form-control form-control-lg  mb-3" type="text" name="name_blog" value="{{ old('name_blog') }}" placeholder="Nhập tên tiêu đề">                        
                            @error('name_blog')
                           ...
                           <label for="cate" class="pt-3 pl-2 "  style=" font-size: 14px;">Chọn tag liên quan</label>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <textarea name = "content"  class="@error('content') is-invalid @enderror form-control editor " id="exampleFormControlTextarea1" rows="10"></textarea>
                                @error('content')
                                <div class="alert alert-danger">{{ $message }}</div>
                                  @enderror
