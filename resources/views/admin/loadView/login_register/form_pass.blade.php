...
@section('content')
                    <form action = "{{route('user.confirm.reset')}}" method = "POST">
                        @csrf
                        <div class="login-form-body">
                        
                            <div class="form-gp">
                                <label for="exampleInputEmail1">Vui long nhap mat khau moi</label>
                                <input type="password" name = "pass" id="exampleInputEmail1">
